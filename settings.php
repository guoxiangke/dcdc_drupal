 ...
 * @endcode
 */
$settings['hash_salt'] = 'O6kuTLE2ZcckHHeQnDv3hV5YxWd0CD4HEF_G2Ob9n4PRwRpRgJUDDK3ssxiNngwSijqFmmQbdg';
...
$settings['update_free_access'] = FALSE;
$filePrivatePath =  __DIR__.'/files/private';
if (!file_exists($filePrivatePath)) {
